...
Full update rules in Appendix~app:optim: AdamW, Lion, cosine schedule; code: Listing~\ref*{lst:adamw}, Listing~\ref*{lst:cosine}.
...
\toprule
\rowcolor{tablehead}\textcolor{white}{**Optimizer**} & \textcolor{white}{**Memory**} & \textcolor{white}{**Speed**} & \textcolor{white}{**Best For**} \\
\midrule
...
\toprule
\rowcolor{tablehead}\textcolor{white}{**Framework**} & \textcolor{white}{**Primary Use**} & \textcolor{white}{**Key Features**} \\
\midrule
