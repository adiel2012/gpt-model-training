...
KV cache formula ([Appendix G](app_g_implementation_treasury.md)), quantization bounds ([Appendix G](app_g_implementation_treasury.md)) in Appendix~app:pipeline; speculative decoding code: [Appendix G](app_g_implementation_treasury.md).
