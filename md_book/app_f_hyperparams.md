...
\begin{tabular}{L{3.5cm}L{2.5cm}L{2.5cm}L{3cm}}
\toprule
\rowcolor{tablehead}\textcolor{white}{**Hyperparameter**} & \textcolor{white}{**7B Model**} & \textcolor{white}{**70B Model**} & \textcolor{white}{**Notes**} \\
\midrule
...
\bottomrule
\end{tabular}
\caption{Pre-training hyperparameter reference}
\end{table}
...
\toprule
\rowcolor{tablehead}\textcolor{white}{**Hyperparameter**} & \textcolor{white}{**Typical Range**} & \textcolor{white}{**Notes**} \\
\midrule
...
\bottomrule
\end{tabular}
\caption{SFT hyperparameter reference}
\end{table}
...
\begin{tabular}{L{3.5cm}L{3cm}L{5cm}}
\toprule
\rowcolor{tablehead}\textcolor{white}{**Hyperparameter**} & \textcolor{white}{**Typical Value**} & \textcolor{white}{**Notes**} \\
\midrule
...
\bottomrule
\end{tabular}
\caption{LoRA and QLoRA hyperparameter reference}
\end{table}
...
\bottomrule
\end{tabular}
\caption{DPO and SimPO hyperparameter reference}
\end{table}
...
\bottomrule
\end{tabular}
\caption{GRPO hyperparameter reference}
\end{table}
...
\centering\small\sffamily
\rowcolors{2}{tablealt}{white}
\begin{tabular}{L{3.5cm}L{3cm}L{4.5cm}}
\toprule
\rowcolor{tablehead}\textcolor{white}{**Symptom**} & \textcolor{white}{**Likely Cause**} & \textcolor{white}{**Fix**} \\
\midrule
...
\bottomrule
\end{tabular}
\caption{Common training failure modes and remediation}
\end{table}
