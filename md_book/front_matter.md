...
Each chapter begins with a **What You Will Learn** overview and a **Mini Table of Contents** for quick navigation. Mathematical formulations are concentrated in the appendices, with direct links provided throughout the text. Ready-to-use PyTorch code exists in [Appendix G](app_g_implementation_treasury.md), serving as the executable companion to the theoretical chapters.


---

[Table of Contents](../README.md#table-of-contents) | [Next Chapter →](ch01_landscape.md)