\chapter{Quick-Start Recipes}

\section{QLoRA SFT with TRL and PEFT}

\begin{lstlisting}[style=pythonstyle, caption={Minimal QLoRA supervised fine-tuning with TRL}]
...
\section{DPO Alignment with TRL}

\begin{lstlisting}[style=pythonstyle, caption={DPO preference alignment with TRL}]
...
\section{GRPO Reasoning Training with TRL}

\begin{lstlisting}[style=pythonstyle, caption={GRPO training for reasoning with verifiable rewards}]
...
\section{Serving with vLLM}

\begin{lstlisting}[style=pythonstyle, caption={Launching a production vLLM OpenAI-compatible server}]
...
\section{Model Merging with mergekit}

\begin{lstlisting}[style=pythonstyle, caption={TIES-merging two LoRA fine-tunes with mergekit (YAML config)}]
# merge_config.yaml
models:
...
\begin{lstlisting}[style=pythonstyle, caption={Running mergekit and evaluating the merged model}]
...
\section{Continual Pre-training on Domain Data}

\begin{lstlisting}[style=pythonstyle, caption={Continual pre-training with replay to prevent forgetting}]
from transformers import AutoModelForCausalLM, AutoTokenizer
